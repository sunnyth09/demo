    ...
    <div class="w-full max-w-md">
      <div class="bg-card rounded-2xl border shadow-lg p-8">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <a :href="`${API_URL}/auth/facebook`" class="h-11 rounded-md border border-input bg-white hover:bg-accent transition-colors flex items-center justify-center gap-2 text-sm font-medium">
